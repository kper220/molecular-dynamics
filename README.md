...
| Week | Summary |
| -- | -- |
| 7/22 - 7/28 | Partial differential equations: introduction, heat equation, explicit scheme.<br>Estimators, mean error (bias), mean squared error (MSE), strong and weak convergence.<br>Show that schemes [ABAO] and [BAOAB] are conjugates. |
